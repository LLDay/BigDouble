...
public class Test {
	...
	public void constructor() {
		...
		assertThrows(IllegalArgumentException.class, () -> new BigDouble(""));
		assertThrows(IllegalArgumentException.class, () -> new BigDouble("."));
		assertThrows(IllegalArgumentException.class, () -> new BigDouble("12345.6789.123"));
		assertThrows(IllegalArgumentException.class, () -> new BigDouble("123,456"));
	...
	public void power() {
		...
		assertTrue(nTwo.toPower(3).plus(nTwo.toPower(2)).equals(new BigDouble(-4)));

		BigDouble someNum = new BigDouble("01651560606031.0653165419000");
		assertTrue(someNum.toPower(0).equals(new BigDouble(1)));
	...
	public void floor() {
		...
		assertTrue(a.floor(0).toString().equals("123"));
		assertTrue(a.floor(1).toString().equals("123.4"));
		assertTrue(a.floor(2).toString().equals("123.45"));
		assertTrue(a.floor(3).toString().equals("123.456"));
		assertTrue(a.floor(4).toString().equals("123.4567"));
		assertTrue(a.floor(5).toString().equals("123.45678"));
		assertTrue(a.floor(6).toString().equals("123.456789"));
		assertTrue(a.floor(7).toString().equals("123.456789"));

		assertTrue(b.floor(0).toString().equals("-43"));
		assertTrue(b.floor(1).toString().equals("-43"));

		assertTrue(c.floor(0).toString().equals("-12"));
		assertTrue(c.floor(1).toString().equals("-12.1"));
		assertTrue(c.floor(2).toString().equals("-12.18"));
	...
	public void round() {
		...
		assertTrue(a.round(0).toString().equals("12"));
		assertTrue(a.round(1).toString().equals("12.3"));
		assertTrue(a.round(2).toString().equals("12.35"));
		assertTrue(a.round(3).toString().equals("12.346"));
		assertTrue(a.round(4).toString().equals("12.3456"));
		assertTrue(a.round(5).toString().equals("12.3456"));

		assertTrue(b.round(0).toString().equals("-43"));
		assertTrue(b.round(1).toString().equals("-43"));

		assertTrue(c.round(0).toString().equals("-13"));
		assertTrue(c.round(1).toString().equals("-12.5"));
		assertTrue(c.round(2).toString().equals("-12.54"));
		assertTrue(c.round(3).toString().equals("-12.538"));
		assertTrue(c.round(4).toString().equals("-12.538"));
	}
}
